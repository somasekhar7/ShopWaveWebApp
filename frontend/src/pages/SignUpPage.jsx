...
const SignUpPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const { user_name, email, phone_number, user_password, confirmPassword } =
      formData;
    signup(user_name, email, phone_number, user_password, confirmPassword);
  };
